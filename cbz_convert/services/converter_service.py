...
class ConverterService:
    ...
    def _collect_images(self, document: Document) -> List[Image.Image]:
        """
    ...
    def convert_pdf_to_cbz(self, format: Format = Format.JPEG, quality: Optional[int] = 85) -> bool:
        """
        ...
        try:
            ...
            images = self._collect_images(document)
